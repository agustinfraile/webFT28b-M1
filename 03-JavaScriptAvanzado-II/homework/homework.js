...
/*
  ...
  Sin modificar la función crearCadena, usar bind para guardar, en las tres variables declaradas a continuación, tres funcionenes bajos, respectivamente). Las funciones obtenidas deberían recibir solamente un argumento - la cadenas que retornen una cadena (string) y el delimitador especificado (asteriscos, guiones, y guio de texto - ya que los otros argumentos habrán sido "bindeados". 
*/
